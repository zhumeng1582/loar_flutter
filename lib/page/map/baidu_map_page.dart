...
class _BodyState extends State<BaiduMapPage> {
  ...
  BaiduLocationIOSOption iosOption =
      new BaiduLocationIOSOption(coordType: BMFLocationCoordType.bd09ll);
  BaiduLocationAndroidOption androidOption =
      new BaiduLocationAndroidOption(coordType: BMFLocationCoordType.bd09ll);
  ...
  BMFMapOptions initMapOptions0() {
    BMFMapOptions mapOptions = BMFMapOptions(
        ...
        center: GlobeDataManager.instance.position);
    return mapOptions;
  }

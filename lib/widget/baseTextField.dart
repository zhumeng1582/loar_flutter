...
class BaseTextField extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _BaseTextFieldState();
}
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(
            color: widget.focusedBorderColor ?? AppColors.commonPrimary,
            width: 0.5,
          ),
...
extension _UI on _BaseTextFieldState {
...
extension _Action on _BaseTextFieldState {
  void isEmpty() {
